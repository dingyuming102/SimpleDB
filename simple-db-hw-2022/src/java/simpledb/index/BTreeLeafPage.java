...
//    leftSibling pointer:  1 * int
//    rightSibling pointer: 1 * int
//    header:               ceiling(no. tuple slots / 8) * byte
//    tuples:               no. tuple slots * tuple size
// Max no. entry slots  = floor((BufferPool.getPageSize()*8 - extra bits) / (tuple size*8 + 1))
// extra bits           = parent pointer * 8 + leftSibling pointer * 8 + rightSibling pointer * 8
